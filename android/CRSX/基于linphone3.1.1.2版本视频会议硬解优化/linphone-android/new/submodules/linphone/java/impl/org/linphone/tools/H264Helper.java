...
public class H264Helper {
    //private static String FILTER_NAME_FFMPEGH264_ENC = "MSH264Enc" ;
    private static String FILTER_NAME_FFMPEGH264_DEC = "MSH264Dec" ;
    ...
    public static void setH264Mode(String mode, LinphoneCore linphoneCore){
        if(mode.equals(MODE_OPENH264)){
            ...
            //linphoneCore.getMSFactory().enableFilterFromName(FILTER_NAME_FFMPEGH264_ENC , false);
            linphoneCore.getMSFactory().enableFilterFromName(FILTER_NAME_FFMPEGH264_DEC , false);
